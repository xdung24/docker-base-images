...
angular-7: ## Build angular-7 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):7 -f angular-7.Dockerfile .

angular-8: ## Build angular-8 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):8 -f angular-8.Dockerfile .

angular-9: ## Build angular-9 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):9 -f angular-9.Dockerfile .

angular-10: ## Build angular-10 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):10 -f angular-10.Dockerfile .

angular-11: ## Build angular-11 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):11 -f angular-11.Dockerfile .

angular-12: ## Build angular-12 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):12 -f angular-12.Dockerfile .

angular-13: ## Build angular-13 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):13 -f angular-13.Dockerfile .

angular-14: ## Build angular-14 and push to docker hub
	@cd angular && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(ANGULAR_TAG):14 -f angular-14.Dockerfile .
...
python-3.6: ## Build python-3.6 and push to docker hub
	@cd python && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(PYTHON_TAG):3.6 -f python-3.6.Dockerfile .

python-3.7: ## Build python-3.7 and push to docker hub
	@cd python && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(PYTHON_TAG):3.7 -f python-3.7.Dockerfile .

python-3.8: ## Build python-3.8 and push to docker hub
	@cd python && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(PYTHON_TAG):3.8 -f python-3.8.Dockerfile .

python-3.9: ## Build python-3.9 and push to docker hub
	@cd python && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(PYTHON_TAG):3.9 -f python-3.9.Dockerfile .

python-3.10: ## Build python-3.10 and push to docker hub
	@cd python && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(PYTHON_TAG):3.10 -f python-3.10.Dockerfile .
...
node-10: ## Build node-10 and push to docker hub
	@cd node && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(NODE_TAG):10 -f node-10.Dockerfile .

node-12: ## Build node-12 and push to docker hub
	@cd node && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(NODE_TAG):12 -f node-12.Dockerfile .

node-14: ## Build node-14 and push to docker hub
	@cd node && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(NODE_TAG):14 -f node-14.Dockerfile .

node-16: ## Build node-16 and push to docker hub
	@cd node && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(NODE_TAG):16 -f node-16.Dockerfile .
...
go-1.18: ## Build go-1.18 and push to docker hub
	@cd go && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(GO_TAG):1.18 -f go-1.18.Dockerfile .

go-1.19: ## Build go-1.19 and push to docker hub
	@cd go && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(GO_TAG):1.19 -f go-1.19.Dockerfile .

go-1.20: ## Build go-1.20 and push to docker hub
	@cd go && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(GO_TAG):1.20 -f go-1.20.Dockerfile .

go-1.21: ## Build go-1.21 and push to docker hub
	@cd go && docker buildx build --platform linux/arm64,linux/amd64 --push --tag $(GO_TAG):1.21 -f go-1.21.Dockerfile .